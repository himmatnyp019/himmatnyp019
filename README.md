...
- 🔭 Currently building: **PWA / TWA apps, MERN stack systems & smart-factory projects**
- 🌱 Learning: **Python, Data Science, Machine Learning, System Design**
- 🎯 Goal: **Become a top-tier AI + Quant developer & build profitable side projects**
...
`JavaScript` · `TypeScript` · `Python` · `Java` · `R` · `MATLAB`

**Frontend**

`React` · `Vite` · `Next.js` · `Tailwind CSS` · `Framer Motion` · `PWA / TWA`
...
`Git` · `GitHub` · `Vercel` · `Render` · `Cloudinary` · `Postman`

---

### 🚀 Highlighted Projects

#### 🛒 SDS Rasa Rahasa – E-Commerce Ecosystem
